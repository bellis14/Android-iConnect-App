    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (data.getCount() == 0) {
            ...
            while(data.moveToNext()){
                ...
                // Send a notification to connect with a person
                if (data.getString(2).equals("1") && difference <= 0) {
                    String message = "Don't forget to connect with " + connection.getName() + " today";
