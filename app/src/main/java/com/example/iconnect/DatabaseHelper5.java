 ...
 * Function: Store information about each person in the fifth
 * group created
 ************************************************************/
public class DatabaseHelper5 extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "personList5.db";
    private static final String TABLE3 = "listGroup5";
