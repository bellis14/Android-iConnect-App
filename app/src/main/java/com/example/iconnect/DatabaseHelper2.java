 ...
 * Function: Store information about each person in the second
 * group created
 ************************************************************/
public class DatabaseHelper2 extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "perGroup2.db";
    private static final String TABLE2 = "gList2";
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTable = "CREATE TABLE " + TABLE2 + " (ID INTEGER PRIMARY KEY AUTOINCREMENT, " +
    ...
    public Cursor getItemID(String name, String identity, String subtitle, String frequency, String note, String setCount) {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "SELECT " + COL1 + " FROM " + TABLE2 +
                " WHERE " + COL2 + " = '" + name + "'" +
                " AND " + COL3 + " = '" + identity + "'" +
                " AND " + COL4 + " = '" + subtitle + "'" +
                " AND " + COL5 + " = '" + frequency + "'" +
    ...
    public void updateDays(String name, String identity, String subtitle, String frequency, String note, String updatedSetCount, int id, String oldSetCount) {
        SQLiteDatabase db = this.getWritableDatabase();
        String query = "UPDATE " + TABLE2 + " SET " + COL7 +
